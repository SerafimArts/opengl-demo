...
interface WindowFlags
{
    ...
    public const SDL_WINDOW_MOUSE_GRABBED      = 0x00000100;
    ...
    public const SDL_WINDOW_KEYBOARD_GRABBED   = 0x00100000;
    public const SDL_WINDOW_VULKAN             = 0x10000000;
    public const SDL_WINDOW_METAL              = 0x20000000;
    public const SDL_WINDOW_INPUT_GRABBED      = self::SDL_WINDOW_MOUSE_GRABBED;
}
